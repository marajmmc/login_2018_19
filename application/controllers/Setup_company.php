...
class Setup_company extends Root_Controller
{
    ...
    {
        $items=Query_helper::get_info($this->config->item('table_login_setup_company'),array('id','short_name','full_name','remarks','status','ordering'),array('status !="'.$this->config->item('system_status_delete').'"'));
