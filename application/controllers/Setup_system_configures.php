...
class Setup_system_configures extends Root_Controller
{
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Setup_system_configures');
        $this->controller_url='setup_system_configures';
    }
    ...
    private function system_list()
    {
        if(isset($this->permissions['action0'])&&($this->permissions['action0']==1))
        {
            ...
            $data['title']="System Configure List";
            $ajax['status']=true;
    ...
    {
        $this->db->from($this->config->item('table_login_setup_system_configures').' system_configures');
    ...
    private function system_add()
    {
        ...
        {
            $data['title']="Create New System Configure";
            $data['item']['id']=0;
            $data['item']['purpose']='';
            $data['item']['description']='';
            $data['item']['config_value']='';
    ...
    private function system_edit($id)
    {
        if(isset($this->permissions['action2'])&&($this->permissions['action2']==1))
        {
            ...
            $data['item']=Query_helper::get_info($this->config->item('table_login_setup_system_configures'),array('*'),array('id ='.$item_id,'status !="'.$this->config->item('system_status_delete').'"'),1,0,array('id ASC'));
            if(!$data['item'])
            {
    ...
    private function system_save()
    {
        ...
        if($id>0)
        {
            ...
            Query_helper::update($this->config->item('table_login_setup_system_configures'),$item,array('id='.$id));
        }
        else
        {
            $item['date_created']=$time;
            $item['user_created']=$user->user_id;
            Query_helper::add($this->config->item('table_login_setup_system_configures'),$item);
        }
