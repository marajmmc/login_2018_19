...
(
    ...
    'href'=>site_url($CI->controller_url.'/index/edit_app_preference/'.$item['id'])
);
$CI->load->view('action_buttons',array('action_buttons'=>$action_buttons));
?>
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_app_preference');?>" method="post">
