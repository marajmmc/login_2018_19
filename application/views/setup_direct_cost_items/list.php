        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_PERCENTAGE');?>', dataField: 'percentage',cellsalign: 'right', width:100, hidden: <?php echo $system_preference_items['percentage']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_STATUS');?>', dataField: 'status',filtertype: 'list',cellsalign: 'center', width:70, hidden: <?php echo $system_preference_items['status']?0:1;?>}
                ]
            });
    });
</script>
