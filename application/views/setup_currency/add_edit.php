...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_SYMBOL');?></label>
            </div>
            <div class="col-sm-4 col-xs-8">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $CI->lang->line('LABEL_AMOUNT_RATE_BUDGET');?></label>
            </div>
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[amount_rate_budget]" id="amount_rate_budget" class="form-control float_type_positive " value="<?php echo $item['amount_rate_budget'];?>"/>
            </div>
        </div>
