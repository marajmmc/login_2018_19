...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $CI->lang->line('LABEL_ADJUST_METHOD');?><span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
                <select id="adjust_method" name="item[adjust_method]" class="form-control">
                    <option value=""><?php echo $this->lang->line('SELECT');?></option>
                    <option value="CASH"><?php echo $this->lang->line('LABEL_ADJUST_CASH');?></option>
                    <option value="CREDIT_BALANCE"><?php echo $this->lang->line('LABEL_ADJUST_CREDIT_BALANCE');?></option>
