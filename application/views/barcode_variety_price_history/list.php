        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_REVISION'); ?>', dataField: 'revision', width:'100',cellsalign: 'right',hidden: <?php echo $system_preference_items['revision']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_FISCAL_YEAR'); ?>', dataField: 'fiscal_year', width:'100',filtertype: 'list',cellsalign: 'right',hidden: <?php echo $system_preference_items['fiscal_year']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_DATE_CREATED'); ?>', dataField: 'date_created', width:'200',cellsalign: 'right',hidden: <?php echo $system_preference_items['date_created']?0:1;?>}
                ]
            });
    });
</script>