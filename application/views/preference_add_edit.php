    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            foreach($system_preference_items as $key=>$value)
            {
                ...
                <div class="col-xs-4">
                    <div class="checkbox">
                        <label><input type="checkbox" class="system_jqx_column" name="system_preference_items[<?php echo $key;?>]" value="1" <?php if($value){echo 'checked';}?>><span class="label label-success"><?php echo $CI->lang->line('LABEL_'.strtoupper($key)); ?></span></label>
                    </div>
                </div>
                <?php
            }
