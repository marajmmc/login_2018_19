...
<div class="row widget">
    ...
    if(isset($CI->permissions['action6']) && ($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-2 "><div class="checkbox"><label><input type="checkbox" class="system_jqx_column" value="stock_total_pkt" <?php if($system_preference_items['quantity_total_pkt']){echo 'checked';}?>><span class=""><?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL_PKT'); ?></span></label></div></div>
        <div class="col-xs-2 "><div class="checkbox"><label><input type="checkbox" class="system_jqx_column" value="stock_total_kg" <?php if($system_preference_items['quantity_total_kg']){echo 'checked';}?>><span class=""><?php echo $CI->lang->line('LABEL_QUANTITY_TOTAL_KG'); ?></span></label></div></div>
        <div class="col-xs-2 "><div class="checkbox"><label><input type="checkbox" class="system_jqx_column" value="amount_price_total" <?php if($system_preference_items['amount_total']){echo 'checked';}?>><span class=""><?php echo $CI->lang->line('LABEL_AMOUNT_TOTAL'); ?></span></label></div></div>
