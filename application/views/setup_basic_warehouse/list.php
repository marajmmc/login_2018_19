    ...
    if(isset($CI->permissions['action6']) && ($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="capacity"><?php echo $CI->lang->line('LABEL_CAPACITY'); ?></label>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CAPACITY'); ?>', dataField: 'capacity',width: '200',cellsalign: 'right'},
